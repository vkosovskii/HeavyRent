...
import com.heavyrent.equipment.mapper.EquipmentMapper;
...
import static com.heavyrent.equipment.mapper.EquipmentMapper.toEntity;
import static com.heavyrent.equipment.mapper.EquipmentMapper.toResponse;
...
public class EquipmentProfileService {
    ...
    public Page<EquipmentProfileResponse> findAll(EquipmentFilterRequest filter, int page, int pageSize) {
        ...
        return equipmentProfileRepository.findAll(spec, pageable).map(EquipmentMapper::toResponse);
    }
}
